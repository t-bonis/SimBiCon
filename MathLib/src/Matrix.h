...
public:
	...
	*/
	void set_to_outer_product(const Vector3d& a, const Vector3d& b);
	...
	*/
	void shallowCopy(const Matrix& other, int startRow = 0, int startCol = 0, size_t endRow = -1, size_t endCol = -1);
	...
	*/
	...
	/**
		...
		make sure dgemv works properly, implement vector class, etc, swap, setDataFromPosition, scale matrices, etc
	*/
